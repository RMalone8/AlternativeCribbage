...
def draw_hand(win, hand: list, discard_list: list) -> list:
    '''
...
def draw_game_objs(win, player_piles: list) -> list:
    '''
...
def discarding_logic(select: int, discard_list: list, crib: list, player_hand: list):
    '''
